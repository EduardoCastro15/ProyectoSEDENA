...
{
    public partial class FormBI5 : Form
    {
        public FormBI5()
        {
            InitializeComponent();
        ...
        private void FormBI5_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                adaptar.Fill(sedenaDataSet, "Totalporpromedio");
                conn.Close();
                ...
                chart1.DataSource = sedenaDataSet.Totalporpromedio;
            }
            catch (Exception ex)
            {
